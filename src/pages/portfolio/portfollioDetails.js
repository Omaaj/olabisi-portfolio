...
export const professionalDetails = [
  {
    ...
    contribution: [
      "Collaborated with frontend engineers to build and enhance customer-facing dashboard pages, including product management and transaction-related screens.",
      "Integrated backend APIs using Axios to fetch and display real-time inventory, customer data, and transaction information, working closely with backend developers to ensure smooth data flow between frontend and server.",
      "Assisted in implementing global state management using Redux Toolkit to handle product listings, transactions, and shared application data across multiple screens.",
      "Improved and completed UI styling using Tailwind CSS, ensuring consistent design across unfinished components and improving overall user experience.",
      "Supported form-based features related to customer actions, product management, and dashboard interactions within the SaaS platform.",
    ],
  ...
  },
  {
    ...
    contribution: [
      "Built the complete responsive frontend interface using React based on provided UI/UX designs",
      "Translated Figma design layouts into clean, reusable React components",
      "Developed dynamic service pages using React routing to display treatment details efficiently",
      "Implemented appointment booking form to capture customer inquiries and send requests directly to the business owner",
      "Integrated interactive map to display business location clearly for clients",
      "Ensured mobile-first responsiveness across all devices",
      "Performed continuous debugging and optimization using Chrome DevTools",
    ],
    stack: "React, CSS, Git",
    challenges: [
  ...
  },
  {
    ...
    contribution: [
      "Built and styled user interface components using HTML, CSS, and JavaScript for internal and client-facing web applications",
      "Converted design layouts into responsive, user-friendly web pages",
      "Assisted developers in improving UI structure and usability across different pages",
      "Implemented basic dynamic behaviors with JavaScript (forms, interactions, content updates)",
      "Fixed UI bugs and layout issues to improve overall user experience",
      "Collaborated with the development team to understand project requirements and workflows",
    ],
